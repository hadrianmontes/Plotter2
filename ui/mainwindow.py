...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.properties_tab, self.xmin_val)
        ...
        MainWindow.setTabOrder(self.comboMarkerColor, self.plot_but)
...
"color for marker", None))
        ...
        self.label_15.setText(_translate("MainWindow", "Marker Color", None))
        self.comboMarkerColor.setItemText(0, _translate("MainWindow", "Auto", None))
        self.comboMarkerColor.setItemText(1, _translate("MainWindow", "Black", None))
        self.comboMarkerColor.setItemText(2, _translate("MainWindow", "Blue", None))
        self.comboMarkerColor.setItemText(3, _translate("MainWindow", "Cyan", None))
        self.comboMarkerColor.setItemText(4, _translate("MainWindow", "Green", None))
        self.comboMarkerColor.setItemText(5, _translate("MainWindow", "Red", None))
        self.comboMarkerColor.setItemText(6, _translate("MainWindow", "Pink", None))
        self.comboMarkerColor.setItemText(7, _translate("MainWindow", "Yellow", None))
