...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.left_pos_radio = QtGui.QRadioButton(self.frame_9)
        self.left_pos_radio.setObjectName(_fromUtf8("left_pos_radio"))
        self.gridLayout_15.addWidget(self.left_pos_radio, 1, 0, 1, 1)
        self.right_pos_radio = QtGui.QRadioButton(self.frame_9)
        self.right_pos_radio.setObjectName(_fromUtf8("right_pos_radio"))
        self.gridLayout_15.addWidget(self.right_pos_radio, 1, 1, 1, 1)
        self.top_pos_radio = QtGui.QRadioButton(self.frame_9)
        self.top_pos_radio.setObjectName(_fromUtf8("top_pos_radio"))
        self.gridLayout_15.addWidget(self.top_pos_radio, 1, 2, 1, 1)
        self.bottom_pos_radio = QtGui.QRadioButton(self.frame_9)
        self.bottom_pos_radio.setObjectName(_fromUtf8("bottom_pos_radio"))
        self.gridLayout_15.addWidget(self.bottom_pos_radio, 1, 3, 1, 1)
        ...
        self.gridLayout_15.addWidget(self.label_28, 0, 0, 1, 4)
        ...
        self.properties_tab.setCurrentIndex(1)
