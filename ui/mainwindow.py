...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.xmin_val.setMinimum(-1e+99)
        self.xmin_val.setMaximum(1e+99)
        ...
        self.xmax_val.setMinimum(-1e+99)
        self.xmax_val.setMaximum(1e+99)
        ...
        self.ymin_val.setMinimum(-1e+99)
        self.ymin_val.setMaximum(1e+99)
        ...
        self.ymax_val.setMinimum(-1e+99)
        self.ymax_val.setMaximum(1e+99)
        ...
        self.gridLayout_2.addWidget(self.frame_8, 4, 0, 1, 2)
        self.frame_9 = QtGui.QFrame(self.axis_prop)
        ...
        self.left_pos_radio = QtGui.QRadioButton(self.frame_10)
        self.left_pos_radio.setChecked(True)
        self.left_pos_radio.setObjectName(_fromUtf8("left_pos_radio"))
        self.gridLayout_16.addWidget(self.left_pos_radio, 0, 0, 1, 1)
        self.right_pos_radio = QtGui.QRadioButton(self.frame_10)
        self.right_pos_radio.setChecked(False)
        self.right_pos_radio.setObjectName(_fromUtf8("right_pos_radio"))
        self.gridLayout_16.addWidget(self.right_pos_radio, 0, 1, 1, 1)
        self.gridLayout_15.addWidget(self.frame_10, 1, 0, 1, 1)
        ...
        self.top_pos_radio = QtGui.QRadioButton(self.frame_11)
        self.top_pos_radio.setChecked(False)
        self.top_pos_radio.setObjectName(_fromUtf8("top_pos_radio"))
        self.gridLayout_17.addWidget(self.top_pos_radio, 0, 0, 1, 1)
        self.bottom_pos_radio = QtGui.QRadioButton(self.frame_11)
        self.bottom_pos_radio.setChecked(True)
        self.bottom_pos_radio.setObjectName(_fromUtf8("bottom_pos_radio"))
        self.gridLayout_17.addWidget(self.bottom_pos_radio, 0, 1, 1, 1)
        self.gridLayout_15.addWidget(self.frame_11, 1, 1, 1, 1)
        self.label_28 = QtGui.QLabel(self.frame_9)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_15.addWidget(self.label_28, 0, 0, 1, 2)
        self.gridLayout_2.addWidget(self.frame_9, 3, 0, 1, 2)
        ...
        self.boxerrorbar = QtGui.QCheckBox(self.add_data_tab)
        self.boxerrorbar.setObjectName(_fromUtf8("boxerrorbar"))
        self.gridLayout_7.addWidget(self.boxerrorbar, 5, 0, 1, 1)
        self.yerrorColumn = QtGui.QSpinBox(self.add_data_tab)
        self.yerrorColumn.setMaximum(999)
        self.yerrorColumn.setObjectName(_fromUtf8("yerrorColumn"))
        self.gridLayout_7.addWidget(self.yerrorColumn, 5, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_19.setText(_translate("MainWindow", "Number of rows:", None))
        self.label_20.setText(_translate("MainWindow", "Number of columns", None))
        ...
        self.left_pos_radio.setText(_translate("MainWindow", "Left", None))
        self.right_pos_radio.setText(_translate("MainWindow", "Right", None))
        self.top_pos_radio.setText(_translate("MainWindow", "Top", None))
        self.bottom_pos_radio.setText(_translate("MainWindow", "Bottom", None))
        self.label_28.setText(_translate("MainWindow", "Axis/Ticks Position", None))
...
"         Color", None))
        ...
        self.boxerrorbar.setText(_translate("MainWindow", "Y errorbar\n"
"Column", None))
