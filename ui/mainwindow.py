...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/undo.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/redo.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        ...
        self.template_tab = QtGui.QWidget()
        self.template_tab.setObjectName(_fromUtf8("template_tab"))
        self.properties_tab.addTab(self.template_tab, _fromUtf8(""))
        ...
        self.label = QtGui.QLabel(self.axis_prop)
        font = QtGui.QFont()
        ...
        self.ymin_val = QtGui.QDoubleSpinBox(self.axis_prop)
        ...
        self.gridLayout_2.addWidget(self.ymin_val, 2, 1, 1, 1)
        self.ymax_val = QtGui.QDoubleSpinBox(self.axis_prop)
        ...
        self.gridLayout_2.addWidget(self.ymax_val, 2, 2, 1, 1)
        self.xmax_val = QtGui.QDoubleSpinBox(self.axis_prop)
        ...
        self.gridLayout_2.addWidget(self.xmax_val, 1, 2, 1, 1)
        self.xmin_val = QtGui.QDoubleSpinBox(self.axis_prop)
        ...
        self.gridLayout_2.addWidget(self.xmin_val, 1, 1, 1, 1)
        self.label_2 = QtGui.QLabel(self.axis_prop)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self.gridLayout_2.addWidget(self.label_2, 0, 1, 1, 1, QtCore.Qt.AlignBottom)
        self.label_5 = QtGui.QLabel(self.axis_prop)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.gridLayout_2.addWidget(self.label_5, 2, 0, 1, 1, QtCore.Qt.AlignRight)
        self.label_3 = QtGui.QLabel(self.axis_prop)
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.gridLayout_2.addWidget(self.label_3, 0, 2, 1, 1, QtCore.Qt.AlignBottom)
        self.label_6 = QtGui.QLabel(self.axis_prop)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_2.addWidget(self.label_6, 3, 0, 1, 1, QtCore.Qt.AlignBottom)
        self.label_4 = QtGui.QLabel(self.axis_prop)
        self.label_4.setObjectName(_fromUtf8("label_4"))
        self.gridLayout_2.addWidget(self.label_4, 1, 0, 1, 1, QtCore.Qt.AlignRight)
        self.gridLayout_3 = QtGui.QGridLayout()
        self.gridLayout_3.setObjectName(_fromUtf8("gridLayout_3"))
        self.semilogx_but = QtGui.QPushButton(self.axis_prop)
        self.semilogx_but.setObjectName(_fromUtf8("semilogx_but"))
        self.gridLayout_3.addWidget(self.semilogx_but, 0, 1, 1, 1)
        self.semilogy_but = QtGui.QPushButton(self.axis_prop)
        self.semilogy_but.setObjectName(_fromUtf8("semilogy_but"))
        self.gridLayout_3.addWidget(self.semilogy_but, 0, 2, 1, 1)
        self.decimal_but = QtGui.QPushButton(self.axis_prop)
        self.decimal_but.setObjectName(_fromUtf8("decimal_but"))
        self.gridLayout_3.addWidget(self.decimal_but, 0, 0, 1, 1, QtCore.Qt.AlignTop)
        self.loglog_but = QtGui.QPushButton(self.axis_prop)
        self.loglog_but.setObjectName(_fromUtf8("loglog_but"))
        self.gridLayout_3.addWidget(self.loglog_but, 0, 3, 1, 1)
        self.gridLayout_2.addLayout(self.gridLayout_3, 4, 0, 1, 3)
        ...
        self.file_path_box = QtGui.QPlainTextEdit(self.add_data_tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.file_path_box.sizePolicy().hasHeightForWidth())
        self.file_path_box.setSizePolicy(sizePolicy)
        self.file_path_box.setMaximumSize(QtCore.QSize(16777215, 30))
        ...
        self.checkBox = QtGui.QCheckBox(self.add_data_tab)
        self.checkBox.setObjectName(_fromUtf8("checkBox"))
        self.gridLayout_7.addWidget(self.checkBox, 3, 2, 1, 2, QtCore.Qt.AlignRight)
        self.comboBox_2 = QtGui.QComboBox(self.add_data_tab)
        self.comboBox_2.setObjectName(_fromUtf8("comboBox_2"))
        self.comboBox_2.addItem(_fromUtf8(""))
        self.comboBox_2.addItem(_fromUtf8(""))
        self.comboBox_2.addItem(_fromUtf8(""))
        self.gridLayout_7.addWidget(self.comboBox_2, 2, 3, 1, 1)
        self.comboBox = QtGui.QComboBox(self.add_data_tab)
        ...
        self.comboBox_3 = QtGui.QComboBox(self.add_data_tab)
        ...
        self.comboBox_3.addItem(_fromUtf8(""))
        self.comboBox_3.addItem(_fromUtf8(""))
        self.gridLayout_7.addWidget(self.comboBox_3, 3, 1, 1, 1)
        ...
        self.properties_tab.setCurrentIndex(2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.properties_tab.setTabText(self.properties_tab.indexOf(self.template_tab), _translate("MainWindow", "Template", None))
...
"the x and y data should be read from:", None))
        self.checkBox.setText(_translate("MainWindow", "Use different \n"
"color for marker", None))
        self.comboBox_2.setItemText(0, _translate("MainWindow", "None", None))
        self.comboBox_2.setItemText(1, _translate("MainWindow", "Point \".\"", None))
        self.comboBox_2.setItemText(2, _translate("MainWindow", "Circle \"o\"", None))
        self.comboBox.setItemText(0, _translate("MainWindow", "Solid: \"-\"", None))
        self.comboBox.setItemText(1, _translate("MainWindow", "Dasded: \"--\"", None))
        self.comboBox.setItemText(2, _translate("MainWindow", "Pointed \".\"", None))
        self.comboBox.setItemText(3, _translate("MainWindow", "Dash point: \"-.\"", None))
        self.comboBox.setItemText(4, _translate("MainWindow", "None", None))
        self.label_14.setText(_translate("MainWindow", "Color", None))
        self.label_13.setText(_translate("MainWindow", "Marker", None))
        self.comboBox_3.setItemText(0, _translate("MainWindow", "Auto", None))
        self.comboBox_3.setItemText(1, _translate("MainWindow", "Blue", None))
        self.comboBox_3.setItemText(2, _translate("MainWindow", "Red", None))
        self.comboBox_3.setItemText(3, _translate("MainWindow", "Yellow", None))
        self.comboBox_3.setItemText(4, _translate("MainWindow", "Cyan", None))
        self.comboBox_3.setItemText(5, _translate("MainWindow", "Black", None))
        self.comboBox_3.setItemText(6, _translate("MainWindow", "Green", None))
        self.comboBox_3.setItemText(7, _translate("MainWindow", "Pink", None))
